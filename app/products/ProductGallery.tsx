  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="relative aspect-[1/1] w-full overflow-hidden rounded-[40px] bg-white shadow-2xl shadow-zinc-200 transition-all duration-700 hover:shadow-emerald-100 ring-1 ring-zinc-100">
        ...
        {/* Floating Actions (Optional like heart/share as shown in reference) */}
        <div className="absolute top-6 right-6 flex flex-col gap-3">
           <button className="h-10 w-10 rounded-full bg-white/80 backdrop-blur-md flex items-center justify-center shadow-lg text-zinc-400 hover:text-rose-500 transition-colors">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
           </button>
           <button className="h-10 w-10 rounded-full bg-white/80 backdrop-blur-md flex items-center justify-center shadow-lg text-zinc-400 hover:text-emerald-500 transition-colors">
