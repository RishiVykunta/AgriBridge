...
export default function HarvesterLoanPage() {
  return (
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="w-full max-w-2xl rounded-xl border border-zinc-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-1 text-sm text-zinc-500">
            Apply for a harvester loan (SBI). Sign in is required to continue.
          </p>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm text-zinc-700">
                <li>Suitable for custom hiring centers</li>
                <li>Quick processing (when integrated)</li>
                <li>Transparent repayment schedule</li>
              </ul>
            </div>
            <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-5">
